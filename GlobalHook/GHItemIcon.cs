...
namespace GH {
	...
	/// アイコンとテキスト
	/// </summary>
	public class GHItemIcon : GHIcon {
		...
		public GHItemIcon(SkinImage skin, FormType windowType) : base(skin, windowType) {
			Init();
		}


		public GHItemIcon(ref Icon hIcon, FormType windowType) : base(ref hIcon, windowType) {
			Init();
		}

		public GHItemIcon(Bitmap bmp, FormType windowType) : base(ref bmp, windowType) {
			Init();
		}
